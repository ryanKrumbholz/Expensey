...
const Login = (props) => {
  ...
  var createAccount = () => {
    ...
    const requestOptions =
    {
      ...
      if (newAccountValidation(email, emailConf,  pword, pwordConf)) {
        fetch('ec2-52-14-88-124.us-east-2.compute.amazonaws.com/users/adduser',requestOptions) 
          .then(res => res.json())
          .then (data => 
            {
  ...
  function validateLogin(email, pword) {
    ...
    fetch('ec2-52-14-88-124.us-east-2.compute.amazonaws.com/users/login',requestOptions) 
          .then(res => res.json())
          .then (data => 
            {
